...
#This is set as original pytorch post: nworkers: 4 and bs 4
t_batch_size=128 # Change this value when needed, also num workers
n_workers=2
...
#Custom line:
model_ft=models.resnet18(num_classes=10)
